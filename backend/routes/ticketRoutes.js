...
router.get("/", authMiddleware.verifyToken, authMiddleware.isAdmin, ticketController.getAllTickets);
...
router.put("/:ticket_id/status", authMiddleware.verifyToken, authMiddleware.isTAOrAdmin, ticketController.updateTicketStatus);
router.put("/:ticket_id/escalate", authMiddleware.verifyToken, authMiddleware.isTA, ticketController.escalateTicket);
router.put("/:ticket_id/reassign", authMiddleware.verifyToken, authMiddleware.isAdmin, ticketController.reassignTicket);
